...
<dl class="user_top">
  ...
  <div class="user_top_list">
    <ul>
      ...
      <li> <a href="user.php?act=account_log"> <strong><?php echo $this->_var['info']['surplus']; ?></strong> <img  src="<?php echo $this->_var['ectouch_themes']; ?>/images/ico_user_03.png"> <span>余额</span> </a> </li>
...
?>
  <tr>
    <td align="center"><?php if ($this->_var['user']['head_url'] != ''): ?><img src="<?php echo $this->_var['user']['head_url']; ?>"  style="width: 3.7rem;height: 3.7rem;border-radius: 3.7rem;"><?php else: ?><img src="<?php echo $this->_var['ectouch_themes']; ?>/images/get_avatar.png" ><?php endif; ?></td>
    <td align="center"><?php echo sub_str($this->_var['user']['nickname'],3); ?>[<?php echo $this->_var['user']['level']; ?>]级</td>
