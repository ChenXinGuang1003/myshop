...
E_D("replace into `wxch_prize_cnum` values('3','4','1','话费100元4','3','2');");
E_D("replace into `wxch_prize_cnum` values('4','18','2','甜心10000','10','1');");
E_D("replace into `wxch_prize_cnum` values('5','16','2','甜心100','10','1');");
E_D("replace into `wxch_prize_cnum` values('6','6','1','未中奖6','10','4');");
