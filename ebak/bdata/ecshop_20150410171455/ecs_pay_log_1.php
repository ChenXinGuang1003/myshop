...
E_D("replace into `ecs_pay_log` values('66','28','589.00','0','0');");
E_D("replace into `ecs_pay_log` values('67','29','253.00','0','0');");
E_D("replace into `ecs_pay_log` values('68','30','285.00','0','0');");
E_D("replace into `ecs_pay_log` values('69','31','800.00','0','0');");
E_D("replace into `ecs_pay_log` values('70','32','50.00','0','0');");
