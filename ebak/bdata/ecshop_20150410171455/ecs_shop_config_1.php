...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','创客源码演示站','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','创客源码演示站','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','创客源码演示站','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','创客源码演示站','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','创客源码演示站','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','85107627','1');");
E_D("replace into `ecs_shop_config` values('110','1','ww','text','','','深圳创客科技有限公司','1');");
...
E_D("replace into `ecs_shop_config` values('905','8','sms_ecmoban_user','text','','','hczhangbo','0');");
E_D("replace into `ecs_shop_config` values('906','8','sms_ecmoban_password','password','','','zhangbo','0');");
