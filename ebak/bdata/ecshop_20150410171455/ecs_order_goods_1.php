...
E_D("replace into `ecs_order_goods` values('34','28','34','兰蔻超塑颜5D提拉日霜法国版50ml','ECS000034','0','1','895.00','589.00','','0','1','','0','0','');");
E_D("replace into `ecs_order_goods` values('35','29','8',' 香奈儿coco小姐唇膏（62#）3g','ECS000008','13','1','300.00','238.00','颜色:黑色 \n','0','1','','0','0','231');");
E_D("replace into `ecs_order_goods` values('36','30','17','娇韵诗超V型纤容紧致瘦脸面膜75ml','ECS000017','6','1','396.00','275.00','颜色:黑色 \n','0','1','','0','0','201');");
E_D("replace into `ecs_order_goods` values('37','31','123','迪奥红毒女士香水EDT 50ml','ECS000123','0','2','820.00','400.00','外        观:红色 \n','0','1','','0','0','297');");
E_D("replace into `ecs_order_goods` values('38','32','12','雅顿保湿调理露200ml','ECS000012','20','1','200.00','50.00','外        观: 红色','0','1','','0','0','321,2');");
