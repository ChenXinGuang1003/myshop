...
E_D("replace into `ecs_user_address` values('8','','18','ceshi','li@xvx.com','1','2','52','500','ceshisdlksdj','123456','12345678909','','','');");
E_D("replace into `ecs_user_address` values('9','','17','刘阳','','1','2','52','500','44255','','13333333333','','','');");
E_D("replace into `ecs_user_address` values('10','','27','ss','','1','3','39','421','ddfgg','','1111','','','');");
